        ...
        if (result.isConfirmed) {
            ...
            fetch('submit_pendaftaran.php', {
                ...
                .then(data => {
                    ...
                    if (!userId) throw new Error('No userId returned from submit_pendaftaran.php');

                    return fetch('https://script.google.com/macros/s/AKfycbxbqEww2tneBmCdLiXPRmbN5fm36Umg9mlQYSRgLYa1bJ6UWnrAzqNAjTKzEejsG74/exec', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded',
                        },
