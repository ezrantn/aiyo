...
<body class="bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center min-h-screen">
  ...
  <div class="bg-white shadow-lg rounded-lg p-8 max-w-lg mx-auto transform transition duration-500 hover:scale-105">
    ...
    <?php if ($status == "NEW") : ?>
      ...
      <div class="flex justify-center mt-6">
        <a href="<?= htmlspecialchars($cekInvoice->responseData->invoiceURL); ?>" target="_blank" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
